...
const FilteredTabTile = React.createClass({
  mixins: [Hoverable],
  ...
  renderTabItems(tabWindow, tabs) {
    ...
    var tabListStyle = Util.merge(Styles.tabList, expandableContentStyle, Styles.tileTabContainer);
    return (
  ...
  render() {
    ...
    var windowStyles = Util.merge(Styles.tabWindow, Styles.expandablePanel, selectedStyle, Styles.tabWindowTile);
...
export default FilteredTabTile;
