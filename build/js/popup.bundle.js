	...
	var R_WindowHeader = React.createClass({displayName: "R_WindowHeader",
	  render: function() {
	    ...
	    if( managed ) {
	      ...
	      windowCheckItem = React.createElement("input", {className: "header-button", type: "checkbox", title: "Bookmark this window (and all its tabs)"});
	    }
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("div", {className: "singlerow nowrap oneRowContainer tabinfo"}, 
	        React.createElement("span", {className: "windowList nowrap singlerow"}, tabTitle)
	      ));
	  }
	...
	var R_TabWindow = React.createClass({displayName: "R_TabWindow",
	  renderTabItems: function(tabs) {
	    ...
	    for (var i = 0; i < tabs.length; i++ ) {
	      var id = "tabItem-" + i;
	      var tabItem = React.createElement(R_TabItem, {tab: tabs[i], key: id});
	      items.push(tabItem);
	    };
	    return items;
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoFocusMixin = __webpack_require__(98);
	var ReactBrowserComponentMixin = __webpack_require__(57);
	var ReactCompositeComponent = __webpack_require__(9);
	var ReactElement = __webpack_require__(12);
	var ReactDOM = __webpack_require__(14);
